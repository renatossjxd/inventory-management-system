...
Incluye un panel administrativo adaptable en `/`, conectado a la API real, con inicio de sesión, indicadores, alertas, actividad reciente, búsqueda, creación de productos, movimientos de stock, órdenes de compra y descarga de reportes.
...
- Administración de usuarios, roles y activación de cuentas desde el panel.
...
| GET | `/api/auth/users` | Lista los usuarios del sistema (solo administradores) |
| PUT | `/api/auth/users/{id}/access` | Actualiza el rol y estado de una cuenta |
...
1. Recuperación y cambio de contraseñas.
2. Pruebas automatizadas de la interfaz web.
